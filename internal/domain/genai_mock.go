...
//
//	mockgen -package=domain -source=./genai_interface.go -destination=./genai_mock.go
//
...
// QueryResuluts mocks base method.
func (m *MockGenAI) QueryResuluts(ctx context.Context, src []byte, prompt string, ch chan<- string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryResuluts", ctx, src, prompt, ch)
	ret0, _ := ret[0].(error)
	return ret0
}

// QueryResuluts indicates an expected call of QueryResuluts.
func (mr *MockGenAIMockRecorder) QueryResuluts(ctx, src, prompt, ch any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryResuluts", reflect.TypeOf((*MockGenAI)(nil).QueryResuluts), ctx, src, prompt, ch)
}
